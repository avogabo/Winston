...
const defaultSettings: Settings = {
  ...
  default_mode: 'preserve', sleep_between_imports: '3s', movies_template: '', series_template: '', filebot_movie_format: '', filebot_series_format: '', filebot_db: 'TheMovieDB', filebot_binary: '/usr/local/bin/filebot', auto_import_medium: true,
}
