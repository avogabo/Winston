...
const defaultSettings: Settings = {
  altmount_base_url: '', altmount_api_key: '', plex_base_url: '', plex_token: '', plex_path_from: '', plex_path_to: '',
  default_mode: 'preserve', sleep_between_imports: '3s', movies_template: '', series_template: '', filebot_movie_format: '', filebot_series_format: '', filebot_db: 'TheMovieDB', auto_import_medium: true,
}
...
export default function App() {
  ...
  useEffect(() => { void loadItems(); void loadSettings() }, [])
